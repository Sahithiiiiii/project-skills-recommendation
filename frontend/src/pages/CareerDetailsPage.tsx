...
import { getCareerDetails, getCareerRoadmap } from "../services/api";
import { useAuth } from "../hooks/useAuth";
import type { CareerDetailsResponse, CareerRoadmapResponse } from "../types/api";
...
export default function CareerDetailsPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([getCareerDetails(token, careerId), getCareerRoadmap(token, careerId)])
      .then(([detailsResponse, roadmapResponse]) => {
  ...
  if (!details || !roadmap) return <div className="page-state">Career unavailable.</div>;
